...
/**
 * Created by qinwei on 2019/1/2 6:00 PM
...
public class EscCommand {
        ...
        for (int var5 = 0; var5 < var4; ++var5) {
            ...
            for (int i = 0; i < output.length; ++i) {
                if (output[i] == -16) {
                    ...
                    this.Command.add(Byte.valueOf("-41"));
                } else {
    ...
    public String genCodeC(String content) {
        ...
        bytes.add(Byte.valueOf("123"));
        bytes.add(Byte.valueOf("67"));
...
//        this.addArrayToCommand(command);
        this.Command.add(Byte.valueOf("27"));
        this.Command.add(Byte.valueOf("33"));
        this.Command.add(Byte.valueOf("63"));
    }
